...
def configure_diffusivity_const():
    ...
    C['Dm_Na'] = {'name': 'base', 'image': 'geo/square/square1.png', 'diffusion constants': {'Dm_Na': 4.478e-18}}
    C['Dm_K'] = {'name': 'base', 'image': 'geo/square/square1.png', 'diffusion constants': {'Dm_Na': 4.478e-18, 'Dm_K': 2.74384e-17}}
    C['Dm_Cl'] = {'name': 'base', 'image': 'geo/square/square1.png', 'diffusion constants': {'Dm_Na': 4.478e-18, 'Dm_K': 2.74384e-17, 'Dm_Cl': 1.973e-19}}
    str(C['Dm_Na'])
    str(C['Dm_K'])
    str(C['Dm_Cl'])
